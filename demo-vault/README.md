...
- **Otherwise**, download `file-explorer-reload-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-file-explorer-reload/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `file-explorer-reload-demo-vault-<version>` folder it unzips into.
